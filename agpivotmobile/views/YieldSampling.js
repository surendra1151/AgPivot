...
export default class YieldSampling extends React.Component{
    ...
    /*functionality for logout on pressing logout it should go to login screen */
    logout(){
            ...
            <View style={{flex:1}}>
                ...
                <View style={{flexDirection:'row'}}>
                    {this.state.recordScreen === 'entry' ?
                        <Text style={styles.yield}>Yield Sampling</Text> :
                        <Text style={styles.yield}>Yield Sampling Table</Text>
                    }
                ...
                <View style={{flexDirection: 'row'}}>
                    <View
                        ...
                        <DropDown
                            name="Russet Silverton"
                            defaultItem="Russet Silverton"
                            value="Russet Silverton"
                    ...
                    <View
                        ...
                        <DropDown
                            name={'Bula Potato Farms'}
                            defaultItem={'Bula Potato Farms'}
                            value={'Bula Potato Farms'}
                ...
                <View style={{flexDirection: 'row', marginRight: 300}}>
                    ...
                    <View
                        style={{flexDirection: 'row', marginTop: 30, marginLeft: 357}}>
                        <Text style={styles.year}>Time</Text>
                        <Text style={{color: 'red'}}>*</Text>
                    </View>
                    <View
                        style={{flexDirection: 'row', marginTop: 30, marginLeft: 352}}>
                        <Text style={styles.year}>Section Of Filed</Text>
                        <Text style={{color: 'red'}}>*</Text>
                    </View>
                </View>
                <View style={{flexDirection:'row'}}>
                    ...
                    <View style={{flexDirection: 'row', marginRight: 300}}>
                        <View
                            style={{marginLeft: 85, marginTop: 30, flexDirection: 'row'}}>
                            <Text style={styles.year}>Sampling Area Length,</Text>
                            <Text style={{color: 'red'}}>*</Text>
                        </View>
                        <View
                            style={{marginLeft: 102, marginTop: 30, flexDirection: 'row'}}>
                            <Text style={styles.year}>(Width 3ft) </Text>
                            <Text style={{color: 'red'}}>*</Text>
                        </View>
                        <View
                            style={{flexDirection: 'row', marginTop: 30, marginLeft: 67}}>
                            <Text style={styles.year}>No# of Plants </Text>
                            <Text style={{color: 'red'}}>*</Text>
                        </View>
                        <View
                            style={{flexDirection: 'row', marginTop: 30, marginLeft: 298}}>
                            <Text style={styles.year}>No# of Stems </Text>
                            <Text style={{color: 'red'}}>*</Text>
                        </View>
                    </View>
                    <View style={{flexDirection: 'row'}}>
                        <TextInput
                            ...
                            onChangeText={sampling => this.setState({sampling})}
                        />
                        <TextInput
                            ...
                            onChangeText={plants => this.setState({plants})}
                        />
                        <TextInput
                            value={this.state.stems}
                            keyboardType={'numeric'}
                            placeholder={''}
                            style={{
                                height: 40,
                            ...
                            onChangeText={stems => this.setState({stems})}
                        />
                    ...
                    <View style={{flexDirection: 'row', marginRight: 300}}>
                        ...
                        <View
                            style={{flexDirection: 'row', marginTop: 30, marginLeft: 340}}>
                    ...
                    />
                    <View style={{marginTop:30,marginLeft:85,flexDirection: 'row'}}>
                        <Text style={styles.year}>Sampling Size Profile</Text>
                        <Text style={styles.comments}>Comments</Text>

                    </View>
                    <View style={{flexDirection: 'row'}}>
                        <Text style={styles.sampling}>Sampling Size Profile will appear after variety selection</Text>
                        <TextInput
                    ...
                    <View style={{alignItems: 'flex-end', marginTop: 30, marginBottom: 50, marginRight: 85}}>
