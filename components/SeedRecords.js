            ...
            <View style={{flex:1}}>
                ...
                <ScrollView horizontal={true}   vertical={true} scrollEnabled={true} onContentSizeChange={this.onContentSizeChange}>
                    <View style={{flex:1}}>
                        <View style={{flexDirection:'row'}}>
                            ...
                            <Text style={styles.yash}>#</Text>
                                {this.state.currentSortDir === 'asc' ?
                                    <Image source={require('../images/up.png')} style={{marginTop: 44, marginLeft: 7.67}}/> :
                                    <Image source={require('../images/Uparrow.png')} style={{marginTop: 44, marginLeft: 7.67, }}/>
                            }
                                {this.state.currentSortDir === 'asc' ?
                                <Image source={require('../images/Downarrow.png')} style={{marginTop: 44, marginLeft: 3}}/>:
                                < Image source = {require('../images/down.png')} style={{marginTop:44,marginLeft:3}}/>
                                }
                            </View>
                            </TouchableHighlight>
                        ...
                        <View style={{borderWidth:1,height:0,borderColor:'#D7D9E0',marginLeft:85,marginTop:10}}/>
