        ...
        return(
            <View style={{flex:1}}>
                ...
                <View style={styles.home}>
                   ...
                   />
                   <Image source={require('../images/Find.png')} style={{marginTop: 110,right:20,height:20,width:20}}/>
                   <Image source={require('../images/Design.png')} style={{marginLeft:18}}/>
                </View>
                ...
                <View style={{ flex:4,flexDirection:'row',backgroundColor: '#F2F2F2'}}>
                    <View style={{ flex:1,flexDirection:'column'}}>
                        ...
                        <Image source={require('../images/infographic.png')} style={{height:120,width:120,marginLeft:110,marginTop:45}}/>
                    </View>
